 ...
 */
#undef  CONFIG_LIB_LIBACL_FORCE
#undef  CONFIG_LIB_LIBAES_FORCE
#undef  CONFIG_LIB_LIBATTR_FORCE
...
#undef  CONFIG_USER_TCL_TCLSH
#undef  CONFIG_USER_NCURSES
...
#define CONFIG_USER_BUSYBOX_CONFIG 1
/*
 * Tinylogin
 */
...
#define CONFIG_PRODUCT "leon2mmu"
#define CONFIG_LINUXDIR "linux-2.6.21.1"
#define CONFIG_LIBCDIR "glibc-from-compiler/build"
